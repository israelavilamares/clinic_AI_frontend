    ...
    <div className="conteinerLogin"> 
      ...
      <div className="div-reg">
        ...
        <p style={{display:'block', color:'white',fontSize:'1.5em'}} >Eficiencia en la salud</p>
          ...
          <label htmlFor="register" style={{display:'block', color:'white',fontSize:'1em',padding:'1em'}}>Ya tienes cuenta?</label>
          
          <Button onClick={goToLogin} label="Inicio de Sesion" style={{display:'block',minWidth:'20vw', fontSize:'1.5em',padding:'1em',fontWeight:'500'}}></Button>
        </div>
      </div>
      <div className="div-log">
        ...
        <h2 style={{fontWeight:'700' ,fontSize:'2.5em', color:'rgb(75, 192, 239)',marginBottom:'10%'}} >Iniciar Sesión</h2>
            <form onSubmit={handleSubmit}>
                ...
                <br />
                <br />
                <Button  label="Entrar" style={{display:'block',minWidth:'20vw', fontSize:'1.5em',padding:'.5em',fontWeight:'500'}}></Button>
